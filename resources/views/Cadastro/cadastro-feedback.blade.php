...
@section('main')
    ...
    <section class="container page-one">
        ...
        <div class="feedback">
            <div class="img-check-feedback">
                <img src="img/check.png" class="img-check" alt="...">
            </div>

            <div class="frase-check-feedback">
                <h1>Parabéns! <br> Seu post foi publicado, esperamos que tenha muito sucesso!</h1>
    ...
    <div class="buttons">
        ...
        <div class="button-voltar">
            <a href="cadastro-etapa-8.html" class="btn-voltar btn btn-default btn-lg">Voltar</a>
        </div>
    </div>
